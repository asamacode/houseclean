                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <h4>${message}</h4>
                                <form:form action="/manager/services/add" modelAttribute="service" method="post"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control">
                                                <form:radiobutton path="special" value="true" label="Có" />
                                                <form:radiobutton path="special" value="false" label="Không" />
                                            </div>
                            ...
                            <div class="form-group mt-4 mb-0"><button class="btn btn-primary btn-block"
                                    type="submit">Thêm dịch vụ</button></div>
                            </form:form>
                        </div>
