                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <h4>${message}</h4>
                                <form:form action="/manager/newscategory/edit" modelAttribute="cat">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group"><label class="small mb-1" for="inputID">ID Danh mục</label>
                                               
                                                <form:input path="id" class="form-control py-4" id="inputID"
                            ...
                            <div class="form-group mt-4 mb-0"><button class="btn btn-primary btn-block"
                                    type="submit">Chỉnh sửa danh mục</button></div>
                            </form:form>
                        </div>
